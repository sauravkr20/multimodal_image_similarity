...
class SearchController:
    def __init__(self, cnn_chroma_search: CNNChromaSearch, clip_chroma_search=CLIPChromaSearch):
        self.cnn_chroma_search = cnn_chroma_search
        self.clip_chroma_search = clip_chroma_search
        self.gemini_service = GeminiDescriptionService(gemini_api_key)

    async def search(self, file: UploadFile, params) -> List[object]:
        ...
        if params.method == "cnn_chroma":
            return await self.cnn_chroma_search.search_image(image, params.top_k)
        
        elif params.method == "clip_chroma":
